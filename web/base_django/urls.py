...
urlpatterns = [
    path('', ReadMeView.as_view(), {'rst_file': os.path.join(settings.REPO_DIR, 'README.rst')}, name='home'),
    path('readme', ReadMeView.as_view(), {'rst_file': os.path.join(settings.REPO_DIR, 'README.rst')}, name='readme'),
